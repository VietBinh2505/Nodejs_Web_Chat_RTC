    ...
    success: result => {
      if (result) {
        targetUsers.forEach(uid => {
          $(".noti_content").find(`div[data-uid=${uid}]`).removeClass("notif-readed-faild");
          $("ul.list-notificatins").find(`li>div[data-uid=${uid}]`).removeClass("notif-readed-faild");
        });
...
$(document).ready(function() {
  $("#popup-mark-notif-as-read").bind("click", function() {
    let targetUsers = [];
    $(".noti_content").find("div.notif-readed-faild").each(function(index, notification) {
  ...
  $("#model-mark-notif-as-read").bind("click", function() {
    let targetUsers = [];
    $("ul.list-notificatins").find("li>div.notif-readed-faild").each(function(index, notification) {
      targetUsers.push($(notification).data("uid"));
    });
